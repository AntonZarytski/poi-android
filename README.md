...
[![Build Status](https://travis-ci.org/AntonZarytski/poi-android.svg?branch=master)](https://travis-ci.org/AntonZarytski/poi-android)
...
```groovy
implementation "com.github.AntonZarytski.poi-android:poi:$poiVersion"
```

If you're using proguard, also add:

```groovy
implementation "com.github.AntonZarytski.poi-android:proguard:$poiVersion"
```
...
1. Fork the repo and
   [update Apache POI](https://github.com/AntonZarytski/poi-android/blob/bddfb4dbb39b4db704af6e4764a4315bc79513f9/build.gradle#L15)
    1. PSA: you can find Apache POI release notes [here](https://poi.apache.org/changes.html)
1. Simply replace `AntonZarytski` in the Gradle dependency with your own GitHub username
